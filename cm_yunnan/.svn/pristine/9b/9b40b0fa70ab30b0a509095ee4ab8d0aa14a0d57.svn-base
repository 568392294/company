...
class Branch(Tianyan):

    def insert_db(self, line, isexistdata="yes"):
        # SQL 插入语句
        if isexistdata == "yes":
            sql = "INSERT INTO \"T_CMP_AFFILIATE\" (\"F_CREATE_TIME\", \"F_UPDATE_TIME\", \"F_COMPANY_NAME\", \"F_FETCH_URL\",\
                    \"F_AFFILIATE_NAME\", \"F_AFFILIATE_URL\", \"F_AFFILIATE_LEADER\", \"F_STATUS\",\
                   \"F_REG_DATE\", \"F_AFFILIATE_ID\") \
                   VALUES(SYSDATE, SYSDATE, :1, :2, :3, :4, :5, :6, :7, :8)"
        else:
            sql = "INSERT INTO \"T_CMP_AFFILIATE\" (\"F_CREATE_TIME\", \"F_UPDATE_TIME\", \"F_COMPANY_NAME\", \"F_FETCH_URL\", \"F_AFFILIATE_ID\") \
    ...
    def onepage_data(self, company_name, company_link):
        ...
        if self.isElementExist('//div[@id="_container_branch"]'):
            elements = browser.find_elements_by_xpath(
                '//div[@id="_container_branch"]//table[@class="table companyInfo-table"]/tbody/tr')
